...
export function AdminLayout() {
  ...
  const renderSidebarContent = () => (
    <>
      <div className="flex h-16 items-center justify-between border-b border-slate-200 px-6 dark:border-[#333333] flex-shrink-0">
      ...
      <nav className="flex-1 overflow-y-auto py-4 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-[#333333]">
                  ...
                  <Link
                    ...
                    className={`flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors ${
                      ...
                      (item.path !== '/admin' &&
                        ...
                        : 'text-[#385361] hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-[#222222]'
                    }`}
                  >
                    <svg
      ...
      <div className="border-t border-slate-200 p-4 dark:border-[#333333] flex-shrink-0">
        <Button
          variant="ghost"
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-h-screen">
        <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 md:px-6 dark:border-[#333333] dark:bg-dark-surface">
          <div className="flex items-center gap-3">
            <button
              className="md:hidden text-slate-500 hover:text-[#385361] dark:text-slate-400 dark:hover:text-slate-200"
        ...
        <main className="flex-1 overflow-y-auto bg-slate-50 p-4 md:p-6 dark:bg-[#030712] min-h-screen">
